...
import { Swipe, SwipeItem,Lazyload ,Badge ,Sidebar, SidebarItem,Collapse, CollapseItem ,Tab, Tabs,Card  ,Image as VanImage,Tag,Button,Form ,Field,
    Checkbox, CheckboxGroup,Stepper,SwipeCell,SubmitBar,ContactCard  ,AddressList ,AddressEdit,Icon,Popup ,Grid, GridItem   } from 'vant';
...
createApp(App)
    ...
    .use(Stepper ).use(SwipeCell ).use(SubmitBar ).use(AddressEdit ).use(AddressList).use(Icon).use(Popup ).use(Grid).use(GridItem)
